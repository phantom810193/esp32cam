...
class Database:
    ...
    def ensure_demo_data(self) -> None:
        """Load deterministic seed data from the canonical SQL script."""
        ...
        if not sql_path.exists():
            _LOGGER.warning("Seed data script %s not found; skipping import", sql_path)
            return
        ...
        _LOGGER.info("Seed data loaded from %s", sql_path)
