...
_CATALOGUE: tuple[Product, ...] = (
    ...
    Product("SKU960101", "經典草莓千層蛋糕", "dessert", 360.0, 0.82),
    Product("SKU960102", "法式焦糖布丁禮盒", "dessert", 320.0, 0.8),
    Product("SKU960103", "可可奶霜鬆餅組", "dessert", 280.0, 0.78),
    Product("SKU960104", "莓果生乳酪塔", "dessert", 340.0, 0.76),
)

_CATEGORY_KEYWORDS: dict[str, tuple[str, ...]] = {
    "breakfast": ("燕麥", "脆片", "穀", "早餐", "吐司"),
    "wellness": ("果汁", "飲", "優格", "能量", "茶", "咖啡"),
